...
export default {
    ...
    return {
      ...
      labelList: {
        ...
        status: {
          ...
          activeVal: '0',
          inactiveVal: '1',
          switchChange: this.handleStatusChange
        },
        amount: {
          labelText: '交易金额(元)',
          minWidth: 120,
  ...
  methods: {
    ...
    handleStatusChange(row) {
      ...
      this.$confirm('确认要"' + text + '""' + row.companyName + '"公司吗?', "警告", {
